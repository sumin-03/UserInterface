...
import com.example.userinterface.databinding.ActivityPowerListBinding;
...
public class PowerListActivity extends AppCompatActivity {
    ...
    private List<Power> filteredList=new ArrayList<>();
    ...
    public static class Power implements Serializable {
        ...
        public String getPlus80() {return plus80;}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityPowerListBinding binding=ActivityPowerListBinding.inflate(getLayoutInflater());
    ...
    private void setupSearch(ActivityPowerListBinding binding) {
    ...
    private void filterList(String name) {
        ...
        if (name.isEmpty()) {
            ...
            for (Power power : powerList) {
                if (power.getName().contains(name)){
                    filteredList.add(power);
                }
            }
        }
        ...
        public ListViewHolder(ListCardBinding binding) {
            ...
            binding.selectButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Power selectedPower=powerList.stream()
                            .filter(p -> p.getName().equals(name))
                            .findFirst()
                            .orElse(null);
                    Intent resultIntent = new Intent();
                    resultIntent.putExtra("power_selected", name);
    ...
    private class ListAdapter extends RecyclerView.Adapter<ListViewHolder> {
        ...
        public ListAdapter(List<Power> list) {
            this.list = list;
        }
