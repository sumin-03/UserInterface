...
import com.example.userinterface.databinding.ActivityPowerRecommendBinding;

public class PowerRecommend extends AppCompatActivity {
    private User currentUser;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        ActivityPowerRecommendBinding binding=ActivityPowerRecommendBinding.inflate(getLayoutInflater());
        ...
        binding.selectGpu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                launcher.launch(new Intent(PowerRecommend.this, GpuListActivity.class));
            }
        });
        binding.btnResult.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                launcher.launch(new Intent(PowerRecommend.this, PowerResult.class)
